...
const statusConfig = {
  done: { label: "مكتمل", icon: CheckCircle, color: "text-green-400", bg: "bg-green-400/10", border: "border-green-400/30" },
  current: { label: "الربع الحالي", icon: Zap, color: "text-primary", bg: "bg-primary/10", border: "border-primary/30" },
  upcoming: { label: "قريباً", icon: Clock, color: "text-yellow-400", bg: "bg-yellow-400/10", border: "border-yellow-400/30" },
  future: { label: "مستقبلاً", icon: Lock, color: "text-muted-foreground", bg: "bg-card", border: "border-border" },
};
          ...
          <div className="container mx-auto max-w-3xl relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                خارطة <span className="text-primary">الطريق</span>
              </h1>
              <p className="text-muted-foreground text-lg">رؤيتنا المستقبلية وما أنجزناه حتى الآن</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-12 px-4">
          <div className="container mx-auto max-w-2xl text-center">
            <div className="bg-card border border-primary/20 rounded-2xl p-8">
              <h3 className="text-xl font-bold mb-2">اقترح ميزة جديدة</h3>
              <p className="text-muted-foreground text-sm mb-5">رأيك يصنع المستقبل — تواصل معنا بأفكارك</p>
              <a
